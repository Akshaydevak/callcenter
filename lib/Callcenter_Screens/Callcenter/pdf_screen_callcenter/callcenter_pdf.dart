...
class CallCenterPrintScreen extends StatefulWidget {
  ...
  final  List<ReadVarriant> table;

  CallCenterPrintScreen({
    this.vendorCode="",
    this.orderCode="",
    this.note="",
    this.remarks="",
  ...
  @override
  _CallCenterPrintScreenState createState() => _CallCenterPrintScreenState();
}

class _CallCenterPrintScreenState extends State<CallCenterPrintScreen> {
...
Future<Uint8List> _generatePdf(PdfPageFormat format, String title,String orderDate,String orderCode,BuildContext context,String vendorCode,
    double? discount,double? actualCost,double? variableAmount,double? vat,String note,String remarks,List<ReadVarriant> table,String mobile,String email,InventoryListModel? model) async {
