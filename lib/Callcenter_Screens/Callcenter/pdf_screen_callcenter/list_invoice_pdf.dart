...
class CallCenterInvoiceListPrintScreen extends StatefulWidget {
  ...
  final  List<LinesAllOrder> table;
  ...
  @override
  _CallCenterInvoiceListPrintScreenState createState() => _CallCenterInvoiceListPrintScreenState();
}

class _CallCenterInvoiceListPrintScreenState extends State<CallCenterInvoiceListPrintScreen> {
  List<BusinessUnitData>? readData;
  String Email="";
  String Mobile="";
  InvoiceOrderCallCenter invoicedata=InvoiceOrderCallCenter();
        ...
        state.maybeWhen(
            ...
            success: (data) {
              setState(() {
                ...
                print("theeeeeeeeeeeeeeeeeeeeeeeeeee");
                Variable.orderIdPayment=invoicedata?.orderCode??"";
                print("gagg${Variable.total}");
                if(invoicedata?.invoiceData==null){
                  widget?.table!=List.from(data.linesCallcenter??[]);
                }
                else{
  ...
  child: Scaffold(
      ...
      body:PdfPreview(
        build: (format) => _generatePdf(format,"title",widget.orderDate, widget.orderCode,context,widget.vendorCode,
            ...
            widget.note,widget.remarks,widget.table,Mobile,Email),
      ),
...
Future<Uint8List> _generatePdf(PdfPageFormat format, String title,String orderDate,String orderCode,BuildContext context,String vendorCode,
    double? discount,double? actualCost,double? variableAmount,double? vat,String note,String remarks,List<LinesAllOrder> table,String mobile,String email) async {
                            ...
                            pw. TableRow(
                                ...
                                children: [
                                  ...
                                  pw. Container(
                                    color:  PdfColor.fromInt(0xff6F91CB),
                                    alignment:pw. Alignment.center,
                                    child:pw.Text(  'Item Name',style:pw. TextStyle(fontSize:height*.013,color: PdfColors.white,)),
                                    height: 35,
                                  ),
                                ...
                                pw. TableRow(
                                    children: [
                                      ...
                                      pw.  Container(
                                        ...
                                        // height: 40,
                                        child:pw. Text(
                                            table[i].variantName?.toString()??"",style:pw. TextStyle(fontSize: height*.013)),
                                      ),
                                      pw.   Container(
                                      ...
                                      pw.   Container(
                                        ...
                                        alignment:pw. Alignment.center,
                                        child:pw. Text(
                                            table[i].uomName??"",style:pw. TextStyle(fontSize: height*.013)),
                                      ...
                                      pw.  Container(
                                        ...
                                        alignment:pw. Alignment.center,
                                        child: pw.Text(
                                            table[i].vatableAmount?.toString()??"",style:pw. TextStyle(fontSize: 8)),
                                        // fontSize: 12,
                                      ...
                                      pw. Container(
                                        ...
                                        alignment:pw. Alignment.center,
                                        child: pw.Text(
                                            table[i].discount?.toString()??"",style:pw. TextStyle(fontSize:height*.013)),
                                      ...
                                      pw. Container(
                                        ...
                                        alignment:pw. Alignment.center,
                                        child:pw. Text(
                                            table[i].vat?.toString()??"",style:pw. TextStyle(fontSize: 8)),
                                      ),
                                      ...
                                      pw. Container(
                                        ...
                                        padding: pw.EdgeInsets.only(top:height*.019),
                                        child:pw. Text(
                                            table[i].total?.toString()??"",style:pw. TextStyle(fontSize: height*.013)),
                                        // fontSize: 12,
                                      ),
