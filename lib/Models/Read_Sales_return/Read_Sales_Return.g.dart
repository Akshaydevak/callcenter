...
_$_ReadSalesReturn _$$_ReadSalesReturnFromJson(Map<String, dynamic> json) =>
    _$_ReadSalesReturn(
      id: json['id'] as int?,
      orderLines: (json['order_lines'] as List<dynamic>?)
          ?.map((e) => OrderLinesReturn.fromJson(e as Map<String, dynamic>))
          .toList(),
      ...
      salesInvoiceCode: json['sales_invoice_code'] as String?,
    );

Map<String, dynamic> _$$_ReadSalesReturnToJson(_$_ReadSalesReturn instance) =>
    <String, dynamic>{
      'id': instance.id,
      ...
      'sales_invoice_code': instance.salesInvoiceCode,
    };

_$_OrderLinesReturn _$$_OrderLinesReturnFromJson(Map<String, dynamic> json) =>
    _$_OrderLinesReturn(
      id: json['id'] as int?,
      inventoryId: json['inventory_id'] as String?,
...
Map<String, dynamic> _$$_OrderLinesReturnToJson(_$_OrderLinesReturn instance) =>
    <String, dynamic>{
      'id': instance.id,
      'inventory_id': instance.inventoryId,
