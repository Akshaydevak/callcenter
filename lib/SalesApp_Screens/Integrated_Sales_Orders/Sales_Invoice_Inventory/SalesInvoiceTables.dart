...
class TopHeaderInvoiceInventory extends StatelessWidget {
   final VoidCallback? onTap;
  const TopHeaderInvoiceInventory({Key? key, this.onTap}) : super(key: key);
...
///////////////////////////////////////////////////////////////////////////////
class TablePartInvoiceInventory extends StatefulWidget {
  ...
  const TablePartInvoiceInventory({Key? key,
  ...
  @override
  State<TablePartInvoiceInventory> createState() => _TablePartInvoiceInventoryState();
}

class _TablePartInvoiceInventoryState extends State<TablePartInvoiceInventory> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<ReadSalesInvoiceInventoryCubit, ReadSalesInvoiceInventoryState>(
...
class ScrollTablesInvoiceInventory extends StatefulWidget {
  ...
  const ScrollTablesInvoiceInventory({Key? key,
    this.newData, this.changeTable, this.taxaAmd,

  }) : super(key: key);

  @override
  State<ScrollTablesInvoiceInventory> createState() => _ScrollTablesInvoiceInventoryState();
}
class _ScrollTablesInvoiceInventoryState extends State<ScrollTablesInvoiceInventory> {
...
////////////////////////////////////////////////////////////////////////////////
class BottomHeaderInvoiceInventory extends StatefulWidget {
  final VoidCallback? onTap;

  const BottomHeaderInvoiceInventory({Key? key,
    this.onTap,
  }) : super(key: key);

  @override
  State<BottomHeaderInvoiceInventory> createState() => _BottomHeaderInvoiceInventoryState();
}
class _BottomHeaderInvoiceInventoryState extends State<BottomHeaderInvoiceInventory> {
