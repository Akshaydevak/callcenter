...
class TopHeaderReturnInventory extends StatelessWidget {
  final VoidCallback? onTap;
  const TopHeaderReturnInventory({Key? key, this.onTap}) : super(key: key);
...
///////////////////////////////////////////////////////////////////////////////
class TablePartReturnInventory extends StatefulWidget {
  ...
  const TablePartReturnInventory({Key? key,
  ...
  @override
  State<TablePartReturnInventory> createState() => _TablePartReturnInventoryState();
}
bool ontap=false;
class _TablePartReturnInventoryState extends State<TablePartReturnInventory> {
...
class ScrollTablesReturnInventory extends StatefulWidget {
  ...
  const ScrollTablesReturnInventory({Key? key,
    this.newData,
    this.changeTable,
    this.taxaAmd,
  ...
  @override
  State<ScrollTablesReturnInventory> createState() => _ScrollTablesReturnInventoryState();
}
List<OrderLines> orderTable = [];
class _ScrollTablesReturnInventoryState extends State<ScrollTablesReturnInventory> {
  ...
  Widget build(BuildContext context) {
    ...
    if(isSelected==false){
      ...
      for (var i = 0; i < widget.newData!.orderLines!.length; i++) {
        ...
        varrientName.add(TextEditingController(text: widget.newData?.orderLines?[i].variantId.toString()??""));
        variantInventoryId.add(TextEditingController(text: widget.newData?.orderLines?[i].inventoryId));
        ...
        soldPrice.add(TextEditingController(text: widget.newData?.orderLines?[i].soldPrice.toString()??""));
                                      ...
                                      TableRow(
                                          children: [
                                            ...
                                            TableCell(verticalAlignment: TableCellVerticalAlignment.middle,
                                                child: textPadding(widget.newData!.orderLines![i].variantId.toString())),
                                            TableCell(verticalAlignment: TableCellVerticalAlignment.middle,
                                                child: textPadding(widget.newData!.orderLines![i].inventoryId.toString())),
                                            TableCell(verticalAlignment: TableCellVerticalAlignment.middle,
...
////////////////////////////////////////////////////////////////////////////////
class BottomHeaderReturnInventory extends StatefulWidget {
  final VoidCallback? onTap;

  const BottomHeaderReturnInventory({Key? key,
    this.onTap,
  }) : super(key: key);

  @override
  State<BottomHeaderReturnInventory> createState() => _BottomHeaderReturnInventoryState();
}

class _BottomHeaderReturnInventoryState extends State<BottomHeaderReturnInventory> {
