...
import 'package:salesapp/salesapp_Screens/Integrated_Sales_Orders/inventery_Cubit/Read_return_Invoice_Cubit/read_return_invoice_inventory_cubit.dart';
...
import '../Sales_Return_Inventory/SidelistReturnInventory.dart';
import 'SalesReturnInvoiceTables.dart';



class SalesReturnInvoiceInventory extends StatefulWidget {


  const SalesReturnInvoiceInventory({Key? key,

  }) : super(key: key);

  @override
  State<SalesReturnInvoiceInventory> createState() => _SalesReturnInvoiceInventoryState();
}
List<SalesRetunnInvoiceOrderLines>returnInvoice = [];
class _SalesReturnInvoiceInventoryState extends State<SalesReturnInvoiceInventory> {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (context) => ReadReturnInvoiceInventoryCubit()..getReturnInvoiceReadInventory(Variable.verticalid!),),

      ],
      child: BlocConsumer<ReadReturnInvoiceInventoryCubit, ReadReturnInvoiceInventoryState>(
        ...
        builder: (context, state) {
          return BlocConsumer<SalesReturnListCubit, SalesReturnListState>(
                    listener: (context, state) {
                      state.maybeWhen(
                        orElse: () {},
                        success: (list) {
