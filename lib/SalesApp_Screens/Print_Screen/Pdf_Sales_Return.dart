...
class PrintScreenSalesReturn extends StatefulWidget {
  ...
  final List<OrderLinesReturn> table;
  ...
  @override
  _PrintScreenSalesReturnState createState() => _PrintScreenSalesReturnState();
}

class _PrintScreenSalesReturnState extends State<PrintScreenSalesReturn> {
  ...
  child: Scaffold(
      ...
      body:PdfPreview(
        build: (format) => _generatePdf(format,"title",widget.orderDate, widget.orderCode,context,widget.vendorCode,
            widget.discount,widget.totalPrice,widget.taxableAmount,widget.unitCost,widget.excisetax,widget.vat,
...
Future<Uint8List> _generatePdf(PdfPageFormat format, String title,String orderDate,String orderCode,BuildContext context,String vendorCode,
    ...
    ,double? excisetax,double? vat,String note,String remarks,List<OrderLinesReturn> table,String mobile,String email) async {
  double height = MediaQuery.of(context).size.height;
  double width = MediaQuery.of(context).size.width;
                                ...
                                pw. TableRow(
                                    children: [
                                      ...
                                      pw.  Container(
                                        padding: pw.EdgeInsets.only(top:height*.019),
                                        alignment:pw. Alignment.center,
                                        child:pw. Text(table[i].totalPrice.toString()??"",style:pw. TextStyle(fontSize:height*.013)),
