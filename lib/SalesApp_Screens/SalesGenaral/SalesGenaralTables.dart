...
class TopHeaderGenaral extends StatelessWidget {
  final VoidCallback? onTap;
  const TopHeaderGenaral({Key? key, this.onTap}) : super(key: key);
...
///////////////////////////////////////////////////////////////////////////////
class TablePartGenaral extends StatefulWidget {
  ...
  const TablePartGenaral({Key? key,
  ...
  @override
  State<TablePartGenaral> createState() => _TablePartGenaralState();
}
bool ontap=false;
class _TablePartGenaralState extends State<TablePartGenaral> {
  ...
  Widget build(BuildContext context) {
        ...
        return BlocConsumer<ReadSalesGenaralCubit, ReadSalesGenaralState>(
...
class ScrollTablesGenaral extends StatefulWidget {
  ...
  const ScrollTablesGenaral({Key? key,
    this.newData,
    this.changeTable,
    this.taxaAmd,
  ...
  @override
  State<ScrollTablesGenaral> createState() => _ScrollTablesGenaralState();
}
List<OrderLines> orderTable = [];
class _ScrollTablesGenaralState extends State<ScrollTablesGenaral> {
...
////////////////////////////////////////////////////////////////////////////////
class BottomHeaderGenaral extends StatefulWidget {
  final VoidCallback? onTap;

  const BottomHeaderGenaral({Key? key,
    this.onTap,
  }) : super(key: key);

  @override
  State<BottomHeaderGenaral> createState() => _BottomHeaderGenaralState();
}

class _BottomHeaderGenaralState extends State<BottomHeaderGenaral> {
